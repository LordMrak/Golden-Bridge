...
<div class="history"><a href="index.php?link=abw" >Golden Bridge</a> :: <a href="index.php?link=products">Продукты</a> :: <a href="index.php?link=products&page=robots">Роботы</a> :: <a href="index.php?link=products&page=mrgray">Global Fant</a></div>
...
<section class="container_pro container_pers ">  
    ...
    <div class="block_info_personal s_box_shadow agress">
         ...
         <h3>Описание</h3>
<p>Данный советник представляет собой воплощение интересной идеи относительно глобального свойства движения цены о котором знает каждый трейдер: цена движется слева на право и периодически ходит вверх и вниз. Это и так понятно, скажите Вы. Но исходя из этой простой мысли мы можем заработать хорошие деньги, и этот робот создан именно по такой технологии.</p>
...
<table class="table_product" cellpadding="10px">
    ...
    <tr>
        ...
        <td><a href="http://www.myfxbook.com/members/Lord_Zeus/golden-bridge--global-fant/1510547" target="_blank"><img style="width:350px;"  border="0" src="http://widgets.myfxbook.com/widgets/1510547/large.jpg"/></a></td>
    </tr>
</table>
...
<table class="table_product" cellpadding="10px">
    ...
    <tr>
    	<td colspan="7"  class="num_z"> Прибыльная стабильная настройка для GBPUSD </td>
    </tr>
    <tr>
    	<td >
        	GBPUSD
    ...
    <tr>
    	<td colspan="7"  class="num_z"> Прибыльная стабильная настройка для EURGBP </td>
    </tr>
    <tr>
    	<td >
        	EURGBP
...
<table  class="block_view_v"  >
	...
	<div class="price"> Цена до конца Июня 2016 <h3>100 000р.</h3> </div> 
	<a id="buy_gray" href="#dialog1" name="modal" place="Global Fant" link="http://g-bridge.ru<? echo $_SERVER['REQUEST_URI'];?>" class="buttom">купить</a>
